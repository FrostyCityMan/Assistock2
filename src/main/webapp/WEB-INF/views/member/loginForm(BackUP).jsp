...
style="width:15%">
    <h2>Click the Happiness!</h2>
<h2><strong>Assistock에 오신것을 환영합니다.</strong></h2>
<p>Assistock은 개인 투자자를 위한 의사결정 도움 플랫폼입니다.</p>
<br>
<br>
</div>
...
<form name="Loginfrm"
      ...
      onsubmit="return loginCheck()"><!-- myscript.js -->

    <table class="table grid">
        <tr>
            <td>ID</td>
            <td style="padding: 50px 0px; padding-left: 30%">
        ...
        <tr>
            <td colspan="2" style="padding-left: 20%">
                <label><input type="checkbox"
                              name="c_id"
                              value="SAVE"<%if(!c_id.isEmpty())out.print("checked"); %>>아이디
                    저장</label>
                &nbsp;&nbsp;&nbsp;
                <a href="agreement.jsp"
                   style="color: inherit;">회원가입</a>
                &nbsp;&nbsp;&nbsp;
                <a href="../find/idFind.jsp"
                   style="color: inherit;">아이디/비밀번호찾기</a>
            </td>
        </tr>
        <tr>
            <td rowspan="2" style="padding-left: 45%">
                <br>
